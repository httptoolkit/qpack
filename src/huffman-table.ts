/**
 * The HPACK/QPACK Huffman code, from RFC 7541 appendix B: for each symbol
 * (byte values 0-255, then EOS as 256), the code value and its length in
 * bits. Generated mechanically from the RFC text and validated as a
 * complete prefix-free code (Kraft sum exactly 1, no prefix conflicts).
 */
